...
"Je m'appelle Paulina"`Je m'appelle Paulina`
...
"Je pense que 320px donnera " +
  320 / 16 +
  "rems"`Je pense que 320px donnera ${
    320 / 16
  }rems`// le string avec un saut de ligne est possible uniquement avec des ``
  `Bonjour et
Bonsoir`
...
### Type conversion, _truthy_ et _falsy_

Nous parlons de _type conversion_ quand nous changeons le type d'une valeur de la manière explicite (c'est moi, le programmeur, qui décide de le faire dans mon script).
...
Ils existent quelques règles concernant la conversion vers le type `"boolean"`. À cette occasion nous allons parler des notions _truthy_ et _falsy._
