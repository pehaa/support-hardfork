...
Nous allons utiliser [ce repo](https://github.com/pehaa/alyramag-custom-b5-build) en tant que le point de départ. Au lieu de charger le fichier bootstrap depuis un _CDN_, nous allons utiliser le _package manager_ [npm](https://www.youtube.com/watch?v=ZNbFagCBlwo) pour installer bootstrap.
